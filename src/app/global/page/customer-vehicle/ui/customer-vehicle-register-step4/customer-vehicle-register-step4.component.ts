...
export class CustomerVehicleRegisterStep4Component implements OnInit {
  ...
  async asyncCallFunctions() {
    ...
    try {
      ...
      this.customerVehicleRegisterStep4UIDTO.error_summary_message_service_Generic = translations['error_summary_message_service_Generic'];
      this.customerVehicleRegisterStep4UIDTO.warn_summary_message_service_Generic = translations['warn_summary_message_service_Generic'];
      ...
      if (error.status == 500) {
        ...
        this.messageService.add({
          ...
          summary: '' + this.customerVehicleRegisterStep4UIDTO.error_summary_message_service_Generic,
