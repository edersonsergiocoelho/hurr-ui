...
export class CustomerVehicleBookingViewInvoiceComponent implements OnInit {
  ...
  async asyncCallFunctions() {
    ...
    try {
      ...
      this.customerVehicleBookingViewInvoiceUIDTO.warn_summary_message_service_Generic = translations['warn_summary_message_service_Generic'];
      this.customerVehicleBookingViewInvoiceUIDTO.error_summary_message_service_Generic = translations['error_summary_message_service_Generic'];
      this.customerVehicleBookingViewInvoiceUIDTO.info_summary_message_service_Generic = translations['info_summary_message_service_Generic'];
      this.customerVehicleBookingViewInvoiceUIDTO.success_summary_message_service_Generic = translations['success_summary_message_service_Generic'];
      ...
      if (this.customerVehicleBookingViewInvoiceUIDTO.customerVehicleBooking.customerVehicle.customerVehicleId != null) {
        ...
        if (customerVehicleFilePhotoServiceFindByCustomerVehicleAndCoverPhoto.status == 200) {
          if (customerVehicleFilePhotoServiceFindByCustomerVehicleAndCoverPhoto.body != null) {
            ...
            this.customerVehicleBookingViewInvoiceUIDTO.customerVehicleBooking.customerVehicle.customerVehicleFilePhoto = customerVehicleFilePhotoServiceFindByCustomerVehicleAndCoverPhoto.body;
            this.customerVehicleBookingViewInvoiceUIDTO.customerVehicleBooking.customerVehicle.dataURI = `data:${this.customerVehicleBookingViewInvoiceUIDTO.customerVehicleBooking.customerVehicle.customerVehicleFilePhoto.contentType};base64,${this.customerVehicleBookingViewInvoiceUIDTO.customerVehicleBooking.customerVehicle.customerVehicleFilePhoto.dataAsByteArray}`;
          }
        }
      }
      ...
      this.messageService.add({
        ...
        summary: this.customerVehicleBookingViewInvoiceUIDTO.error_summary_message_service_Generic,
