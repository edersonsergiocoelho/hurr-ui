...
export class CustomerVehicleBookingSuccessComponent implements OnInit {
  ...
  async asyncCallFunctions() {
    ...
    try {
      ...
      this.customerVehicleBookingSuccessUIDTO.warn_message_service_Generic = translations['warn_message_service_Generic'];
      this.customerVehicleBookingSuccessUIDTO.error_message_service_Generic = translations['error_message_service_Generic'];
      this.customerVehicleBookingSuccessUIDTO.info_message_service_Generic = translations['info_message_service_Generic'];
      this.customerVehicleBookingSuccessUIDTO.success_message_service_Generic = translations['success_message_service_Generic'];
